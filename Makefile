...
PROJECT_NAME          ?= asteruga
PROJECT_VERSION       ?= 1.0
PROJECT_BUILD_PATH    ?= _build_linux_x64

RAYLIB_PATH           ?= /usr/local/src/raylib

# Locations of raylib.h and libraylib.a/libraylib.so
# NOTE: Those variables are only used for PLATFORM_OS: LINUX, BSD
RAYLIB_INCLUDE_PATH   ?= /usr/local/src/raylib/src
RAYGUI_INCLUDE_PATH   ?= /usr/local/src/raygui/src
RAYLIB_LIB_PATH       ?= /usr/local/src/raylib/src
